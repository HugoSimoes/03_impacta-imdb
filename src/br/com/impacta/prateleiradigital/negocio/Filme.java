...
/**
 * CLASSE QUE REPRESENTA O CONCEITO DE FILME DENTRO DO DOMÍNIO DA APLICAÇÃO
 * DESENVOLVIDA
 * 
 * @author HUGO ÂNGELO
 *
...
public class Filme {
	 ...
	 * @param nota       Nota média atribuída ao filme. Deve estar entre 0 e 10
	 *                   inclusive
	 ...
	 * @param numDeVotos Quantidade de votos recebida pelos usuários. Deve ser maior
	 *                   ou igual a zero
	 * @param url        URL que contém mais informações do filme, como Trailer,
	 *                   Sinopse e etc.
	 */
